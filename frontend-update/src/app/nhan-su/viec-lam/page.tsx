...
import { JOB_CATEGORIES, EMPLOYMENT_TYPES, LOCATIONS } from "@/lib/constants";
import {
  Search,
  MapPin,
  Clock,
...
const dummyJobs = [
  {
    ...
    category: "logistics",
    description: "Tiếp nhận, kiểm đếm và sắp xếp hàng hóa trong kho. Làm việc theo ca.",
                  ...
                  {LOCATIONS.map((loc) => (
                    <label key={loc.id} className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        onChange={() =>
                          setSelectedLocation(selectedLocation === loc.label ? "" : loc.label)
                        }
                        className="w-4 h-4 text-[#065f46] focus:ring-[#065f46]"
                      />
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              <p className="text-gray-600">
                Tìm thấy <strong className="text-gray-900">{filteredJobs.length}</strong> việc làm
              </p>
                    ...
                    >
                      ...
                      <div className="flex md:flex-col items-center gap-2 md:gap-4">
                        <Badge variant="staffing">
                          {EMPLOYMENT_TYPES.find((t) => t.id === job.employmentType)?.label}
                        </Badge>
