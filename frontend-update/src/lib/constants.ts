...
export const COMPANY_INFO = {
  ...
  partners: '200+',
  address:
    'Tầng 15, Tòa nhà Landmark 81, Vinhomes Central Park, Bình Thạnh, TP.HCM',
  phone: '0901 234 567',
  hotline: '1900 1234',
...
export const INTERIOR_NAV = [
  ...
  },
  {
    ...
    children: [
      {
        label: 'Thiết kế nội thất trọn gói',
        href: '/noi-that/dich-vu/thiet-ke-tron-goi',
      },
      { label: 'Thi công ALU', href: '/noi-that/dich-vu/thi-cong-alu' },
      { label: 'Gia công CNC', href: '/noi-that/dich-vu/gia-cong-cnc' },
      {
        label: 'Bảng hiệu & Signage',
        href: '/noi-that/dich-vu/bang-hieu-signage',
      },
      { label: 'Quầy bar & Cafe', href: '/noi-that/dich-vu/quay-bar-cafe' },
      {
        label: 'Showroom & Cửa hàng',
        href: '/noi-that/dich-vu/showroom-cua-hang',
      },
...
export const STAFFING_NAV = [
  {
    ...
    children: [
      { label: 'Tất cả việc làm', href: '/nhan-su/viec-lam' },
      {
        ...
        href: '/nhan-su/viec-lam?category=logistics',
      },
      { label: 'Sản xuất', href: '/nhan-su/viec-lam?category=san-xuat' },
      {
        label: 'Lao động phổ thông',
        href: '/nhan-su/viec-lam?category=lao-dong-pho-thong',
      },
      {
        label: 'Bán hàng & Marketing',
        href: '/nhan-su/viec-lam?category=ban-hang',
      },
    ],
  },
  {
...
export const WHY_CHOOSE_US = [
  ...
  },
  {
    ...
    description:
      'Đã triển khai thành công hơn 1000 dự án lớn nhỏ trên toàn quốc',
    icon: 'CheckCircle',
  },
  {
    id: 3,
