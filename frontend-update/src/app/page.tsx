...
import { Award, Building2, Download, FileText, Shield } from 'lucide-react';
...
export default function HomePage() {
  return (
    <>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center !px-4">
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-4 !mt-4">
              ...
              <div className="pt-8 space-y-4 flex flex-col gap-4">
                <div className="aspect-square rounded-2xl overflow-hidden">
                  <img
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              <strong>{COMPANY_INFO.name}</strong> là đơn vị tiên phong trong
              lĩnh vực thiết kế thi công nội thất và cung ứng nhân sự tại Việt
              Nam. Với hơn 10 năm kinh nghiệm, chúng tôi tự hào mang đến giải
              pháp toàn diện cho mọi doanh nghiệp.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              <Button variant="primary" size="lg" className="!p-2">
                Tìm hiểu thêm
              </Button>
      ...
      <Section variant="gray" padding="lg" className="!mt-12 !px-4">
        <div className="grid md:grid-cols-3 gap-6">
          {/* License Card 1 */}
          <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-200 !p-4 flex flex-col gap-4">
          ...
          {/* License Card 2 */}
          <div className="bg-white p-6 rounded-2xl shadow-md !p-4 border border-gray-200 flex flex-col gap-4">
          ...
          {/* Profile Card */}
          <div className="bg-gradient-to-br from-[#1a365d] to-[#2b4c7e] p-6 rounded-2xl text-white !p-4 flex flex-col gap-4">
            ...
            <a
              ...
              download
              className="inline-flex items-center w-[max-content] gap-2 !px-5 !py-2 bg-[#c9a962] text-[#1a365d] font-semibold rounded-lg hover:bg-white transition-colors"
            >
