...
export default function QuotePage() {
      ...
      <Section padding="xl">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-8">
            Cảm ơn bạn đã quan tâm đến dịch vụ của chúng tôi. Đội ngũ tư vấn sẽ
            liên hệ lại trong vòng 24 giờ để thảo luận chi tiết về dự án của
            bạn.
          </p>
  ...
  return (
    <>
      {/* Hero */}
      <section className="bg-interior-gradient !py-4">
        <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Không phát sinh chi phí tư vấn
              </p>
            </div>
          </div>
        </div>
      ...
      <Section padding="xl">
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className=" lg:col-span-2">
            <Card padding="lg" className="!p-2">
              ...
              <form
                ...
                className="space-y-6 !p-4 flex flex-col gap-4"
              >
                {/* Personal Info */}
                <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 bg-white focus:outline-none focus:ring-2 focus:ring-[#1a365d] resize-none !px-2"
                  />

                  {/* File Upload */}
                  <div className="mt-4 p-6 border-2 border-dashed border-gray-300 rounded-xl text-center hover:border-[#1a365d] transition-colors cursor-pointer !p-4 flex flex-col items-center justify-center gap-2">
          ...
          {/* Sidebar */}
          <div className="space-y-6 h-full flex flex-col gap-4 !mt-4">
            {/* Contact Card */}
            <Card
              variant="elevated"
              className="bg-[#1a365d] text-white !p-4 flex flex-col gap-2"
            >
              ...
              <div className="space-y-4 flex flex-col gap-2">
                <a
                  ...
                  className="flex items-center gap-3 p-3 bg-white/10 rounded-lg hover:bg-white/20 transition-colors !px-4 "
                >
