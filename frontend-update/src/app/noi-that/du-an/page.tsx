...
import { Section, Container, SectionHeader, Badge, Button } from "@/components/ui";
import { MapPin, Calendar, Ruler, Eye, Filter, Grid, LayoutList, ArrowRight } from "lucide-react";
...
export default function ProjectsPage() {
  ...
  return (
    <>
      {/* Hero */}
      <section className="bg-interior-gradient py-20">
        <Container>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-white/80">
              Khám phá những công trình ấn tượng mà chúng tôi đã thực hiện cho các
              đối tác trên khắp Việt Nam
            </p>
          </div>
        </Container>
      </section>
      ...
      {/* Filters */}
      <Section padding="md" className="border-b">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={cn(
                ...
                viewMode === "grid" ? "bg-[#1a365d] text-white" : "text-gray-500"
              )}
            >
            ...
            <button
              ...
              className={cn(
                "p-2 rounded-lg transition-colors",
                viewMode === "list" ? "bg-[#1a365d] text-white" : "text-gray-500"
              )}
            >
          ...
          {filteredProjects.map((project, index) => (
            ...
            >
              <Link
                ...
                className={cn(
                  "group block bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all",
              ...
              >
                ...
                <div
                  className={cn(
                    ...
                    viewMode === "grid" ? "aspect-[4/3]" : "md:w-80 aspect-video md:aspect-auto"
                  )}
                >
                  <img
                    src={project.image}
